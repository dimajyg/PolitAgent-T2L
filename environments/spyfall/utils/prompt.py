...
# Определение моделей вывода
class DescribeOutput(BaseModel):
    """Модель для структурированного вывода описания."""
...
class VoteOutput(BaseModel):
    """Модель для структурированного вывода голосования."""
...
# Шаблон для описания со структурированным выводом
...
# Шаблон для голосования со структурированным выводом
